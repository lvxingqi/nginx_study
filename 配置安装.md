...
- <a href="#将nginx配置成systemctl可以管理的服务">4、将nginx配置成systemctl可以管理的服务</a>
- <a href="#手动启动">5、手动启动</a>
- <a href="#重载Systemd守护进程的配置文件使新的配置生效">6、重载Systemd守护进程的配置文件，使新的配置生效</a>
- <a href="#将nginx配置成systemctl可以管理的服务">6、将nginx配置成systemctl可以管理的服务</a>
